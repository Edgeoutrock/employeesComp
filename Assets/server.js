  ...
  inquirer
    .prompt({
      ...
      choices: [
        ...
        "Show the total amount earned by a department",
...
function showEarnings(){
  ...
  var query = "SELECT department_id, SUM(salary) earnings_total FROM title WHERE department_id = ? ORDER BY earnings_total DESC";
...
function showJobs() {
  inquirer
    .prompt({
      name: "department",
      type: "input",
      message: "What is the id of the department with a number of employees?"
    })
    .then(function(answer) {

      var query = "SELECT COUNT(*) total_jobs FROM title WHERE department_id = ?";
...
function changeManager(){
  ...
  connection.query(query, [answer.emp_manageid, answer.emp_firstName, answer.emp_id],/*[answer.dep_id,answer.dep_name] *//*, {department: answer.department}*/ function (err, res) {
    // console.log(res);
      ...
      console.log("these are the available id in the department table. The title must have a department_id that is in the department table or insertion will not work." + 
...
function deleteEmployee(){
  ...
  inquirer
    ...
    },
    {
      name: "emp_id", 
      type: "input",
      message: "What is the specific id for the employee?"
    }
  ...
  var query = "DELETE from employee WHERE first_name= ? AND id= ?";
  connection.query(query, [answer.emp_firstName, answer.emp_id],/*[answer.dep_id,answer.dep_name] *//*, {department: answer.department}*/ function (err, res) {
    // console.log(res);
...
function showRole2() {
  ...
  //   .then(function(answer) {
      ...
      var query = "SELECT title FROM title";
...
function deleteRole(){
  ...
  var query = "DELETE from title WHERE title = ?";
...
function findRole(){
  var query = "SELECT id FROM title";
  connection.query(query, /*[answer.dep_id,answer.dep_name] *//*, {department: answer.department}*/ function(err, res) {
    // console.log(res);
...
function addRole() {
  ...
  inquirer
    ...
    .then(function(answer) {
      ...
      var query = "INSERT into title ( id, title, salary, department_id) VALUES (?,?,?,?)";
    ...
    .prompt([
      {
        name: "new_role",
        type: "input",
        message: "What is the new role (title) id  for employee?",
